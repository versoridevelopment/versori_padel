...
export default function ReservasPage() {
  ...
  return (
    // FIX 1: h-[100dvh] para mejor soporte en móviles
    <div className="h-[100dvh] bg-slate-100 flex flex-col overflow-hidden">
      {/* FIX 2: Bajamos el z-index a z-10 para que no tape al Sidebar global (hamburguesa) */}
      <header className="bg-white border-b border-gray-200 px-4 py-3 flex flex-col md:flex-row justify-between items-center gap-3 shrink-0 z-10 relative shadow-sm">
        <div className="flex items-center justify-between w-full md:w-auto">
          ...
          <button
            onClick={() =>
              setSidebarState({ isOpen: true, mode: "create", reservaId: null })
            }
